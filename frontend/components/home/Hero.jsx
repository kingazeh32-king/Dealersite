    ...
    <section className="relative overflow-hidden bg-navy-deep text-white">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-28 lg:px-8">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          <div>
            <p className="text-sm font-semibold uppercase tracking-widest text-gold">{hero.eyebrow}</p>
            <h1 className="mt-4 text-4xl font-bold leading-[1.15] tracking-tight sm:text-5xl lg:text-6xl">
              {hero.title}
            </h1>
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-slate-300">{hero.description}</p>
          ...
          <div className="rounded-xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
            <p className="text-sm font-medium uppercase tracking-wide text-gold">{hero.cardTitle}</p>
